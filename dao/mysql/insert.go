...
func InsertActivityInfo(activityInfo constant.ActivityInfo) error{
	...
	_, err = db.Exec("insert into ActivityTable(activityName,commodityId,originPrice,price,stocks,activityStartTime,activityEndTime,available_stock) values(?,?,?,?,?,?,?,?)", activityInfo.ActivityName, activityInfo.CommodityId, activityInfo.OriginPrice, activityInfo.Price,activityInfo.Stocks,activityInfo.ActivityStartTime,activityInfo.ActivityEndTime, activityInfo.AvailableStock)
	if err != nil {
